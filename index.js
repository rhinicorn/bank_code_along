...
function handleTransaction(transaction){
    ...
    //start building the transaction log entry, has to wait for last value
...
/*
ALTERNATE OPTION FOR SORTING
    transactionArr.sort((pre,e) => e.tID).forEach((entry) => {
        let tableRow = document.createElement('tr')
        let tID = document.createElement('th')
        let tType = document.createElement('td')
        let tAmount = document.createElement('td')
